...
| Contract Chat and evidence validation | [`adr/004-fail-closed-contract-chat-output-validation.md`](adr/004-fail-closed-contract-chat-output-validation.md), [`adr/007-canonical-contract-chat-evidence-envelope.md`](adr/007-canonical-contract-chat-evidence-envelope.md), `backend/main.py`, `backend/contract_chat_agent.py`, evidence/citation services, session repository/routes, frontend chat components, tests | [`ARCHITECTURE.md`](ARCHITECTURE.md) requires refresh |
