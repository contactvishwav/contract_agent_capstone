...
async def test_output_guard_validators_use_the_selected_provider_model():
    ...
    raw_model.ainvoke = AsyncMock(side_effect=[
        ...
        SimpleNamespace(content='REASONING: All claims are supported.\nJSON: {"decision":"supported","reason_category":"supported","unsupported_material_claims":0,"confidence":1.0}'),
    ])
