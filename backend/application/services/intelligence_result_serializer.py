...
def intelligence_to_response_dict(contract_id: str, model: str, intelligence) -> Dict[str, Any]:
    ...
    return {
        ...
        "model_used": model,
        "requested_model": getattr(intelligence, "requested_model", model),
        "actual_model": getattr(intelligence, "actual_model", model),
        "requested_provider": getattr(intelligence, "requested_provider", None),
        "actual_provider": getattr(intelligence, "actual_provider", None),
        "fallback_occurred": bool(getattr(intelligence, "fallback_occurred", False)),
        "fallback_reason": getattr(intelligence, "fallback_reason", None),
        "configuration_version": getattr(intelligence, "configuration_version", None),
